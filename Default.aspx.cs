   ...
   public partial class _Default : SecuredPage
   {
      ...
      private string GetTreeDataJson(PoliceReportSummary[] summaryList)
      {
         ...
         if (summaryList != null || summaryList.Length > 0)
         {
            ...
            var data = from s1 in summaryList
                       ...
                       select new
                       {
                          ...
                          children = from s2 in dateGroup
                                     ...
                                     select new
                                     {
                                        ...
                                        children = from s3 in offenseGroup
                                                   orderby s3.OccurrenceDate.Date descending, s3.AddressBlock ascending
                                                   select new
                                                   {
